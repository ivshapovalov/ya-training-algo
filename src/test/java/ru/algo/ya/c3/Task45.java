...
public class Task45 extends ContestTask {
    ...
    public static void main1(String[] args) {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            q.offer(new String[]{"" + rowFrom, "" + colFrom, "1", "0", "0"});
...
//        String expected = getFileContent(class, "/src/main/java/algo.c3/t_final/tE/03.a.txt");
//        System.setIn(testIn);
//        main(new String[0]);
//        assertStringEqualsIgnoreLineSeparators(expected, getOutput());
//    }
...
//    }
    ...
    static class VisitedCell {
        ...
        public VisitedCell(int step, Dir dir) {
            this.step = step;
            this.dirs = new HashSet<>(Arrays.asList(dir));
        }
